var ClinicianForm = (function() {
	...
	function sendEmail(email, firstName) {
		...
		// window.open('mailto:' + email + '?cc=pathadmin@path.sunnybrook.ca&subject=Your PATH Account&body=' + accountInformation);
		$('#rc').html('<p>' + currentRc + '.<br>\
			<a href="mailto:' + email + '?cc=pathadmin@path.sunnybrook.ca&subject=Your PATH Account&body=' + accountInformation + '" title="Send ' + firstName + ' an email">Send ' + firstName + ' an email.</a></p>');
	}
